	...
	testCases := []testCase{
		{
			...
			FilePath: "../../tests/certs/p12/without_password_certificate.p12",
			Password: "",
			ExpectedResults: []CertificateInfo{
				{
					Name:    "TestCert",
		...
		},
		{
			...
			FilePath: "../../tests/certs/p12/with_password_certificate.p12",
			Password: "password",
			ExpectedResults: []CertificateInfo{
				{
					Name:    "TestCert",
		...
		},
		{
			...
			FilePath:        "../../tests/certs/p12/broken_certificate.p12",
			Password:        "",
			ExpectedResults: []CertificateInfo{{}},
		...
		},
		{
			...
			FilePath: "../../tests/certs/p12/chain_certificate.p12",
			Password: "password",
			ExpectedResults: []CertificateInfo{
				{
					Name:    "TestCert",
